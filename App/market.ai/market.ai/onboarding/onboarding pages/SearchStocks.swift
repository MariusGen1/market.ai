...
let top50stocks: [Stock] = [
    Stock(name: "Apple", ticker: "AAPL", marketCap: 3872409585350, iconUrl: URL(string: "https://api.polygon.io/v1/reference/company-branding/YXBwbGUuY29t/images/2025-04-04_icon.png")!, hardcodedImage: Image("apple-logo-asset")),
    ...
    Stock(name: "Visa", ticker: "V", marketCap: 335170000000, iconUrl: URL(string: "https://api.polygon.io/v1/reference/company-branding/dmlzYS5jb20/images/2025-04-04_icon.png")!),
    Stock(name: "Exxon Mobil", ticker: "XOM", marketCap: 108570000000, iconUrl: URL(string: "https://api.polygon.io/v1/reference/company-branding/eG9tLmNvbQ/images/2025-04-04_icon.png")!),
    Stock(name: "JPMorgan Chase", ticker: "JPM", marketCap: 243550000000, iconUrl: URL(string: "https://api.polygon.io/v1/reference/company-branding/anBtLmNvbQ/images/2025-04-04_icon.png")!),
    Stock(name: "Procter & Gamble", ticker: "PG", marketCap: 161020000000, iconUrl: URL(string: "https://api.polygon.io/v1/reference/company-branding/cGcuY29t/images/2025-04-04_icon.png")!),
    Stock(name: "Mastercard", ticker: "MA", marketCap: 533480000000, iconUrl: URL(string: "https://api.polygon.io/v1/reference/company-branding/bWFzdGVyY2FyZC5jb20/images/2025-04-04_icon.png")!),
    Stock(name: "Home Depot", ticker: "HD", marketCap: 357580000000, iconUrl: URL(string: "https://api.polygon.io/v1/reference/company-branding/aG9tZWRlcG90LmNvbQ/images/2025-04-04_icon.png")!),
    Stock(name: "Chevron", ticker: "CVX", marketCap: 138730000000, iconUrl: URL(string: "https://api.polygon.io/v1/reference/company-branding/Y2hlei5jb20/images/2025-04-04_icon.png")!),
    Stock(name: "Eli Lilly", ticker: "LLY", marketCap: 884540000000, iconUrl: URL(string: "https://api.polygon.io/v1/reference/company-branding/ZWxpbGlsbHkuY29t/images/2025-04-04_icon.png")!),
    Stock(name: "Merck & Co.", ticker: "MRK", marketCap: 82740000000, iconUrl: URL(string: "https://api.polygon.io/v1/reference/company-branding/bWVyY2suY29t/images/2025-04-04_icon.png")!),
    Stock(name: "PepsiCo", ticker: "PEP", marketCap: 133380000000, iconUrl: URL(string: "https://api.polygon.io/v1/reference/company-branding/cGVwc2ljby5jb20/images/2025-04-04_icon.png")!),
    Stock(name: "Coca-Cola", ticker: "KO", marketCap: 71910000000, iconUrl: URL(string: "https://api.polygon.io/v1/reference/company-branding/Y29jYS1jb2xhLmNvbQ/images/2025-04-04_icon.png")!)
]
